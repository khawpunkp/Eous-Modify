...
onMounted(async () => {
   ...
   // An import fires mods-changed rather than scan-complete, and can add a mod to this very list —
   // including when the user was already on this page, where the navigation that follows an import is
   // a no-op and would refresh nothing.
